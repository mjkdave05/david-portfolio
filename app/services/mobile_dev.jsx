...
const projects = [
  {
    ...
    image: "/assets/default-placeholder.png",
    github: "",
  },
  {
    num: "02",
                ...
                {projects.map((project, index) => {
                  return (
                    <SwiperSlide key={index} className="w-full">
                      <div className="relative w-[270px] h-[480px] mx-auto overflow-hidden rounded-xl border border-gray-200 shadow-lg">
                        <Image
                          src={project.image || "/assets/default-placeholder.png"}
                          fill
